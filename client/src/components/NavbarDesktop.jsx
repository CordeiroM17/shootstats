...
const NavbarDesktop = () => {
  ...
  useEffect(() => {
    // Split the location pathname for use in active links and icons
  ...
  return (
    <aside className="asideDesktop">
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link to={'/shooters'} className={pathname === 'shooters' ? 'activeLink' : 'inactiveLink'}>
